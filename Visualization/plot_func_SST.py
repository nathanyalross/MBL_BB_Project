...
def plot_line(dataset,
                        ...
                        xlabel='Sweeps',
                        drug_region=(5, 15),
                        drug_effect_region=(11,15), #biggest effect of drug
                        drug_alpha=0.2,
                        drug_effect_alpha = 0.3,
                        drug_color='gray',
    ...
    drug_effect_region: tuple (start_idx, end_idx) for highlighting drug peak effect region
    drug_alpha: transparency of drug region shading
    drug_effect_alpha: transparency of drug region shading
    ...
    # Highlight drug peak effect region
    if drug_effect_region is not None:
        ax.axvspan(drug_effect_region[0], drug_effect_region[1],
                   alpha=drug_effect_alpha, color=drug_effect_color,
                   label='Drug Effect Peak', zorder=0)
    # Customize axes
