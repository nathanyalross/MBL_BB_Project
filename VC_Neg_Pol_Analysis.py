...
def plot_event_overlay_BL(file_path):
    ...
    # ==============================================================================
    sweep_numbers = [1,2,3] #check if counting from 0 or 1
...
trace.savefig(export_path, format='pdf', dpi=300)
#export_path = export_dir / f"{filename}_VC_trace.svg"
#trace.savefig(export_path, format='svg')
